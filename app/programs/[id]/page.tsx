...
export default async function ProgramPage({
  ...
  const { data: program } = await supabase
    .from("programs")
    .select("id, name, status, notes, data, client_id, assessment_id")
    .eq("id", id)
    .maybeSingle();
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="text-cream font-medium">
                      Generated by the IMS Program Engine
                    </div>
                    <div className="text-xs text-cream-faint">
                      838 exercises · FRA priority rotation · autoregulated progression
                    </div>
                  </div>
                </div>
