...
import {ClassIntelligenceLink} from "@/components/classes/class-intelligence-link";
...
export default async function ClassLaunchPage(){
 ...
 const definitions=[
  ...
  {table:"class_waitlist_offers",label:"Waitlist offer records",meaning:"Offer evidence only. An offer does not prove acceptance or a booked seat."},
 ] as const;
