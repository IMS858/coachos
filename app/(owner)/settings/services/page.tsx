    ...
    <AppShell expectedRole="owner">
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-lg border border-divider bg-navy-soft/50 p-4 text-sm text-cream-faint">
          <strong className="text-cream-dim">Build status:</strong> Read-only
          view. Edit modal + Stripe sync coming next. Placeholders 1-3 are seeded
          inactive — toggle on, name, price, and they're live.
        </div>
      </div>
    </AppShell>
  );
