...
export default async function AssessmentPage({
  ...
  const data: AssessmentData = {
    ...
    pain_map: { ...base.pain_map, ...obj(stored.pain_map) },
    lifestyle: { ...base.lifestyle, ...obj(stored.lifestyle) },
    posture: { ...base.posture, ...obj(stored.posture) },
    movement_screen: { ...base.movement_screen, ...obj(stored.movement_screen) },
    strength_baseline: {
    ...
    strength_markers: { ...base.strength_markers, ...obj(stored.strength_markers) },
