...
export default async function ClientProfilePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AppShell><div className="flex min-w-0 flex-col gap-6">
    ...
    <section className="rounded-3xl border border-sky/15 bg-gradient-to-br from-white via-white to-sky/5 p-4 shadow-sm sm:p-5"><p className="mb-3 text-xs font-semibold uppercase tracking-[.16em] text-sky">Coach actions</p><nav aria-label="Client actions" className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
