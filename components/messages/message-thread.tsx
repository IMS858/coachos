            ...
            >
              ...
              <div
                className={`max-w-[75%] rounded-2xl px-4 py-2.5 text-sm ${
                  mine
                    ? "bg-sky/12 border border-sky/35 text-cream rounded-br-md"
      ...
      <div className="border-t border-divider p-3">
        ...
        <div className="flex items-end gap-2">
          <textarea
            ...
            className="flex-1 resize-none rounded-lg border border-divider bg-navy px-3.5 py-2.5 text-sm text-cream placeholder:text-cream-faint focus:outline-none focus:border-sky/60"
          />
