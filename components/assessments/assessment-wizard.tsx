...
/* ----------------------------------------------------------------------------
 * Assessment payload — stored verbatim in assessments.data (jsonb).
 * Keep this shape stable: it's the input contract for the program generator.
 * ------------------------------------------------------------------------- */

type Rating = "good" | "limited" | "painful" | "";
