              ...
              <CardContent className="p-4">
                ...
                {isOpen && (
                  <div className="mt-4 border-t border-divider pt-4 flex flex-col gap-3">
                    {/* Convert to client */}
                    <div className="flex items-center justify-between rounded-lg bg-sky/5 border border-sky/20 px-3 py-2">
                      <div className="text-xs text-cream-dim">
                        {l.email ? (
                          <>Ready to convert — creates a client account.</>
                        ) : (
                          <>Add an email to convert this lead to a client.</>
                        )}
                      </div>
                      <Button
                        size="sm"
                        onClick={() => convertLead(l.id, !!l.email)}
