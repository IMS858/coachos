...
export function StaffBottomNav() {
  ...
  return (
    <>
      ...
      <nav className="safe-bottom fixed bottom-0 left-0 right-0 z-40 border-t border-divider bg-navy-deep/95 backdrop-blur supports-[backdrop-filter]:bg-navy-deep/80 lg:hidden">
