...
VALUES
  ...
  ('massage_60',    '60-min Massage',       'Standard therapeutic massage',   'recovery', 60, true,  true,  false, NULL, NULL,  40, true),
  ('massage_90',    '90-min Massage',       'Extended therapeutic massage',   'recovery', 90, true,  true,  false, NULL, NULL,  50, true),
